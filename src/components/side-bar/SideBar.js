...
export default function SideBar({ setIsError, setError, setAlert, searchData, setConvoSelected, highlightConvo, setHighlightConvo, setConvoInfo, convoInfo, dMessageList, channelList, setChannelList }) {
