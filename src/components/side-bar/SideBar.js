...
export default function SideBar({ searchData, setConvoSelected, highlightConvo, setHighlightConvo, setConvoInfo, convoInfo }) {
      ...
      <section className='sidebar-wrapper'>
        ...
        {isSearching ? <SearchList setConvoInfo={setConvoInfo} setConvoSelected={setConvoSelected} searchingFor={searchingFor} passedSearch={searchData} highlightConvo={highlightConvo} setHighlightConvo={setHighlightConvo}/> :
          <div className='sidebar-channel-dmessage-wrapper'>
            <ConvoList convoInfo={convoInfo} setConvoInfo={setConvoInfo} setConvoSelected={setConvoSelected} highlightConvo={highlightConvo} setHighlightConvo={setHighlightConvo}/>
          </div>
        }
      </section>
    </>
